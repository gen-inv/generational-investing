                    ...
                    <div id="daily-trade-section" class="section hidden">
                        ...
                        <div id="dt-performance-tab" class="daily-trade-tab-content">
                            ...
                            <div class="mb-6 flex gap-2">
                                ...
                                <button onclick="loadPerformanceStats('rolling')" id="dt-filter-rolling" class="px-4 py-2 bg-orange-600 text-white rounded-lg font-semibold" id="dt-rolling-window-filter">Last 50 Trades</button>
