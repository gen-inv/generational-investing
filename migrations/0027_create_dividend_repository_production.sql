-- Migration: Create dividend repository for production deployment
-- This migration combines 0024, 0025, and 0026 into a single user-agnostic structure
-- Migrations 0021-0023 are already applied in production

-- Create user-agnostic dividend_repository table
CREATE TABLE IF NOT EXISTS dividend_repository (
  ...
  UNIQUE(ticker, ex_date)  -- One dividend per ticker per ex-date (global)
);
